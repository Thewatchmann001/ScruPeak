# 🚀 ScruPeak Quick Reference Guide
...
from app.services.advanced_automation import ScruPeakAIChatbot

chatbot = ScruPeakAIChatbot()
...
### Automation & AI
- `ScruPeakAIChatbot` - Intent classification, NLP
