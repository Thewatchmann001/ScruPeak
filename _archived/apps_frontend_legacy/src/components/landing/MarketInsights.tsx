  ...
  return (
    <div className="bg-white py-16">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <p className="text-gray-600 mb-12">Real-time insights into Sierra Leone's land market</p>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Price Trends */}
          <div className="bg-white border-2 border-gray-200 rounded-xl p-6 hover:border-orange-500 transition-all hover:shadow-lg">
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="flex justify-between mb-2">
                  ...
                  <span className="text-lg font-black text-orange-500">↑ 8%</span>
                </div>
                <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
