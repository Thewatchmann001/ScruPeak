...
import { Mail, Lock, Loader2, Eye, EyeOff, CheckCircle2, ChevronRight } from 'lucide-react';
    ...
    <div className="min-h-screen flex font-sans bg-white">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 md:p-16">
        ...
        >
          ...
          <p className="text-text-secondary mb-10 font-medium">Please enter your details to sign in.</p>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  <label className="text-xs font-bold uppercase tracking-wider text-text-muted" htmlFor="password">Password</label>
                  <Link to="/auth/forgot-password" size="sm" className="text-xs font-bold text-primary hover:underline">Forgot password?</Link>
                </div>
                <div className="relative group">
