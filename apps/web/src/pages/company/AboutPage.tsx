...
export default function AboutPage() {
  return (
    <Container className="py-12">
      <PageHeader 
        title="About ScruPeak Digital Property"
        description="Revolutionizing land ownership and trade in Sierra Leone." 
      />
      <div className="prose max-w-none">
        <p>ScruPeak Digital Property is Sierra Leone's premier digital land marketplace, dedicated to bringing transparency, security, and efficiency to real estate transactions.</p>
